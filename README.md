...
6. [실행 화면(기능 설명)](##-6.-실행-화면(기능-설명))
    - 6-1. [올바르지 않은 메뉴 입력 상황](###-1.-올바르지-않은-메뉴-입력-상황)
    - 6-2. [올바른 메뉴 입력](###-2.-올바른-메뉴-입력)
    - 6-3. [올바르지 않은 유저 입력](###-3.-올바르지-않은-유저-입력)
    - 6-4. [올바른 유저 입력 및 사용자 승리](###-4.-올바른-유저-입력-및-사용자-승리)
    - 6-5. [올바른 유저 입력 및 컴퓨터 승리](###-5.-올바른-유저-입력-및-컴퓨터-승리)
7. [트러블 슈팅](##-7.-트러블-슈팅)
   - 7-1. [잘못된 입력의 오류처리](###-1.-잘못된-입력의-오류처리)
   - 7-2. [잘못된 입력을 받았을 때, loop하여 다시 입력 받기](###-2.-잘못된-입력을-받았을-때,-loop하여-다시-입력-받기)
   - 7-3. [winner 결정](###3.-winner-결정)
8. [참고 링크](##-8.-참고-링크)
9. [아쉬운 점](##-9.-아쉬운-점)
